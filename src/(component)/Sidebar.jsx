            ...
            <div className="px-3 py-4 overflow-y-auto bg-gray-200 dark:bg-gray-800">
                ...
                <div>
                    <div className="bg-gray-300 dark:bg-gray-700 rounded-lg text-gray-900  dark:text-white">
                        <h1 className="text-2xl font-bold text-white text-center py-4 rounded-md">
                            Projects
                        </h1>
                    </div>
                ...
                {role == "1" &&
                    <div className="px-3 py-4 bg-gray-200 dark:bg-gray-800">
                        ...
                        <ul className="pt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
                            <li>
                                <Link href="/newuser" className="flex items-center p-2 text-gray-300 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
                                    <svg className="w-3.5 h-3.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
                                        <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 1v16M1 9h16" />
                                    </svg>
